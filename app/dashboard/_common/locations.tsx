...
export function Locations({ dateRange }: { dateRange?: DateRange }) {
  ...
  return (
    <Card>
      ...
      <CardContent className="p-0 relative">
        ...
        {tooltip && (
          <div
            className="fixed z-50 px-3 py-2 text-sm bg-popover text-popover-foreground border border-border rounded-lg shadow-lg pointer-events-none"
            style={{
              left: `${tooltip.x}px`,
              top: `${tooltip.y - 60}px`,
